...
X_train4, X_test4,Y_train4,Y_test4 = train_test_split(X,Y4,test_size=0.2,random_state=2)
...
def Visualize():
    ...
    oe = 0
    et = 0
    for i in df["Diet"].values:
        if i==1:
            oe+=1
        elif i == 0:
            et+=1
    plt.title("Diet Graph")
    plt.bar(np.array(["Diet-Yes","Diet-No"]),np.array([oe,et]),color=["yellow","pink"])
    plt.show()
    ...
    plt.title("Age - AlcoholDrinking Graph")
    plt.show() 
...
@app.route("/TrainSVM")
def TrainSVM():
    global classifier,accmod,svm_teacc,svm_tracc,classifier1,classifier2,classifier3,classifier4,classifier5,classifier6
    ...
    svmtrpred4 = classifier4.predict(X_train4)
    svmtr_acc4 = accuracy_score(svmtrpred3,Y_train4)
    print('Accuracy on training data : ', svmtr_acc4*100)
    ...
    svmtepred4= classifier3.predict(X_test4)
    svmte_acc4 = accuracy_score(svmtepred4,Y_test4)


    print('Accuracy on test data : ', svmte_acc4*100)
    ...
    svm_teacc2 = svmte_acc2*100
    svm_teacc3 = svmte_acc3*100
    svm_teacc4 = svmte_acc4*100
    svm_teacc5 = svmte_acc5*100
    svm_teacc6 = svmte_acc6*100
    
    svm_tracc1 = svmtr_acc1*100
    svm_tracc2 = svmtr_acc2*100
    svm_tracc3 = svmtr_acc3*100
    svm_tracc4 = svmtr_acc4*100
    svm_tracc5 = svmtr_acc5*100
    svm_tracc6 = svmtr_acc5*100
    ...
    num_list = [svm_teacc1,svm_teacc2,svm_teacc3,svm_teacc4,svm_teacc5,svm_teacc6]
    svm_teacc = sum(num_list)/len(num_list)
    
    num_list1 = [svm_tracc1,svm_tracc2,svm_tracc3,svmtr_acc4,svm_tracc5,svm_tracc6]
    svm_tracc = sum(num_list1)/len(num_list1)

    
    svmtepred_list = [svmtepred1,svmtepred2,svmtepred3,svmtepred5,svmtepred6]
    Y_testlist  = [Y_test1,Y_test2,Y_test3,Y_test4,Y_test5,Y_test6]    
    ra = r.randint(0,4)
...
@app.route("/TrainKNN")
def TrainKNN():
    global KNN,accmod,knn_teacc,knn_tracc,KNN1,KNN2,KNN3,KNN5,KNN6,KNN4
    global le1, le2, le3, le4, le5, le6, le7, le8, le9, le10, le11, le12, le13, le14, le15, le16, le17
    ...
    trpred4 = KNN4.predict(X_train4)
    tr_acc4 = accuracy_score(trpred4,Y_train4)
    print('Accuracy on training data : ', tr_acc4*100)
    ...
    tepred4 = KNN4.predict(X_test4)
    te_acc4 = accuracy_score(tepred4,Y_test4)
    print('Accuracy on test data : ', te_acc4*100)
    ...
    num_list = [teacc1,teacc2,teacc3,te_acc4,teacc5,teacc6]
    teaccc = sum(num_list)/len(num_list)
    
    num_list1 = [tracc1,tracc2,tracc3,tracc4,tracc5,tracc6]
    traccc = sum(num_list1)/len(num_list1)

    
    tepred_list = [tepred1,tepred2,tepred3,tepred4,tepred5,tepred6]
    Y_testlist  = [Y_test1,Y_test2,Y_test3,Y_test4,Y_test5,Y_test6]    
    ra = r.randint(0,4)
...
@app.route("/TrainGB")
def TrainGB():
    global GBC,accmod,gb_teacc,gb_tracc,GBC1,GBC2,GBC3,GBC4,GBC5,GBC6
    global le1, le2, le3, le4, le5, le6, le7, le8, le9, le10, le11, le12, le13, le14, le15, le16, le17
    ...
    num_list = [teacc1,teacc2,teacc3,teacc4,teacc5,teacc6]
    teaccc = sum(num_list)/len(num_list)
...
@app.route("/TrainETC")
def TrainETC():
    global ETC,accmod,etc_teacc,etc_tracc,ETC1,ETC2,ETC3,ETC5,ETC6,ETC4
    global le1, le2, le3, le4, le5, le6, le7, le8, le9, le10, le11, le12, le13, le14, le15, le16, le17
...
@app.route("/TrainLGBM")
def TrainLGBM():
    global LGBM,accmod,lgbm_teacc,LGBM1,LGBM2,LGBM3,LGBM5,LGBM6,lgbm_tracc,LGBM4
    global le1, le2, le3, le4, le5, le6, le7, le8, le9, le10, le11, le12, le13, le14, le15, le16, le17
    ...
    trpred4 = LGBM4.predict(X_train4)
    tr_acc4 = accuracy_score(trpred4,Y_train4)
    print('Accuracy on training data : ', tr_acc4*100)
...
@app.route("/TrainMLP")
def TrainMLP():
    global le1, le2, le3, le4, le5, le6, le7, le8, le9, le10, le11, le12, le13, le14, le15, le16, le17, MLP,accmod,mlp_teacc,MLP4,MLP1,MLP2,MLP3,MLP5,MLP6,mlp_tracc
    ...
    MLP4 = MLPClassifier(random_state=1, max_iter=1000)
...
@app.route('/TrainRF')
def TrainRF():
    global le1, le2, le3, le4, le5, le6, le7, le8, le9, le10, le11, le12, le13, le14, le15, le16, le17,RF,accmod,rf_teacc,RF1,RF2,RF3,RF4,RF5,RF6,rf_tracc
...
@app.route('/TrainCNN')
def TrainCNN():
    global le1, le2, le3, le4, le5, le6, le7, le8, le9, le10, le11, le12, le13, le14, le15, le16, le17,model,accmod,cnntestacc,model1,model2,model3,model5,model6,model4
    ...
    model4.add(Conv1D(32, kernel_size=3, activation="relu", input_shape=input_shape))
    ...
    model4.fit(X_train4, Y_train4, batch_size=64, epochs=20, validation_data=(X_test4, Y_test4))
    ...
    tepred4 = model4.predict(X_test4)
    ...
    trpred4 = model4.predict(X_train4)
    ...
    loss4, accuracy4 = model4.evaluate(X_train4, Y_train4, verbose=1)
    loss5, accuracy5 = model5.evaluate(X_train5, Y_train5, verbose=1)
    loss6, accuracy6 = model6.evaluate(X_train6, Y_train6, verbose=1)  
    cnntrainacclist=[accuracy1,accuracy2,accuracy3,accuracy4,accuracy5,accuracy6]
    ...
    loss_v4, cnnaccuracy_v4 = model4.evaluate(X_test4, Y_test4, verbose=1)
    ...
    cnntestacclist=[cnnaccuracy_v1,cnnaccuracy_v2,cnnaccuracy_v3,cnnaccuracy_v4,cnnaccuracy_v5,cnnaccuracy_v6]
    ...
    cml4= []
    for i4 in tepred4:cml4.append(round(i4[0]))
    ...
    cm4 = confusion_matrix(cml4,Y_test4)
    cm5 = confusion_matrix(cml5,Y_test5)
    cm6 = confusion_matrix(cml6,Y_test6)
    
    cmll = [cml1,cml2,cml3,cml4,cml5,cml6]
    rr = r.randint(0,4)
    Y_testl = [Y_test1,Y_test2,Y_test3,Y_test4,Y_test5,Y_test6]
...
def TrainMCNNN():
    ...
    global le1, le2, le3, le4, le5, le6, le7, le8, le9, le10, le11, le12, le13, le14, le15, le16, le17,mmodel,accmod,mmodel1,mmodel2,mmodel3,mmodel5,mmodel6,mmodel4
    ...
    # Create a sequential model
        ...
        mmodel4 = tf.keras.models.Sequential()
    ...
    # Add a 1D convolutional layer with 32 filters and a kernel size of 3
        ...
        mmodel4.add(Conv1D(64, kernel_size=ks, activation="relu", input_shape=input_shape))
    ...
    # Add a max pooling layer with a pool size of 2
        ...
        mmodel4.add(MaxPooling1D(pool_size=2))
    ...
    # Add two dense layers with 64 and 32 nodes, respectively
        ...
        mmodel4.add(Dense(64, activation="relu"))
        ...
        mmodel4.add(Dense(32, activation=activ))
    ...
    # Add a final dense layer with 1 node and a linear activation function for regression
        ...
        mmodel4.add(Dense(1, activation="linear"))
    ...
    #model.compile(loss="mse", optimizer="adam")
        ...
        mmodel4.compile(optimizer=optim, loss='categorical_crossentropy', metrics=['accuracy'])
    ...
    # Train the model on the numerical dataset
        ...
        mmodel4.fit(X_train4, Y_train4, batch_size=bs, epochs=eps, validation_data=(X_test4, Y_test4))
    ...
    # Evaluate the model on a test set
        ...
        scoress4 = mmodel4.predict(X_test4)
    ...
    #cnnaccu = accuracy_score(Y_test,scoress)
        ...
        tepred4 = mmodel4.predict(X_test4)
    ...
    #cnnaccu = accuracy_score(Y_test,scoress)
        ...
        trpred4 = mmodel4.predict(X_train4)
    ...
    #scores = model.evaluate(X_test, Y_test1, verbose=0)
        ...
        scores4 = mmodel4.evaluate(X_test4, Y_test4, verbose=0)
        ...
        loss4, accuracy4 = mmodel4.evaluate(X_train4, Y_train4, verbose=1)
        ...
        loss_v4, cnnaccuracy_v4 = mmodel4.evaluate(X_test4, Y_test4, verbose=1)
        ...
        print("train:accuracy = %f  " % (mcnntrainacc))
        print("Test: accuracy = %f  " % (mcnntestacc))
        ...
        LABELS = ['Yes', 'No'] 
        conf_matrix = confusion_matrix(Y_test3,cmll[rr])
        #conf_matrix = cmll[rr]
        plt.figure(figsize =(6, 6)) 
        ax = sns.heatmap(conf_matrix, xticklabels = LABELS, yticklabels = LABELS, annot = True, cmap="viridis" ,fmt ="g");
        ax.set_ylim([0,2])
...
def PredictAction():
    if request.method == 'POST':
        ...
        BreathingProblem=request.form['t13']
        ...
        data = 'Sex,Age,BMI,Smoking,AlcoholDrinking,Diet,cholesterol,Stress,Race,Exercise,BreathingProblem,GenHealth,SleepTime,HeartDisease\n'
        data+=Sex+","+Age+","+BMI+","+Smoking+","+AlcoholDrinking+","+Fruits+","+cholesterol+","+Stress+","+Race+","+Exercise+","+BreathingProblem+","+GenHealth+","+SleepTime+","+Heart
        ...
        #norm8 = normalize([df[df.columns[8]]])
        norm11 = normalize([dff[dff.columns[12]]])
        #norm5 = normalize([df[df.columns[5]]])
    
        #df[df.columns[7]]=norm7[0][0:]
        dff[dff.columns[1]]=norm1[0][0:]
        dff[dff.columns[2]]=norm2[0][0:]
        dff[dff.columns[12]]=norm11[0][0:]
        #df[df.columns[8]]=norm8[0][0:]
        #df[df.columns[5]]=norm5[0][0:]
        ...
        if modelss == "classifier":classifierr = [classifier1,classifier2,classifier3,classifier4,classifier5,classifier6]
        if modelss == "MLP":MLPP =[MLP1,MLP2,MLP3,MLP4,MLP5,MLP6]
        if modelss == "RF":RFF =[RF1,RF2,RF3,RF4,RF5,RF6]
        if modelss == "CNN":modelll=[model1,model2,model3,model4,model5,model6]
        if modelss == "MCNN":mmodelll =[mmodel1,mmodel2,mmodel3,mmodel4,mmodel5,mmodel6]
        if modelss == "ETC":ETCC =[ETC1,ETC2,ETC3,ETC4,ETC5,ETC6]
        if modelss == "GBC":GBCC =[GBC1,GBC2,GBC3,GBC4,GBC5,GBC6]
        if modelss == "LGBM":LGBMM=[LGBM1,LGBM2,LGBM3,LGBM4,LGBM5,LGBM6]
        if modelss == "KNN":KNNN =[KNN1,KNN2,KNN3,KNN4,KNN5,KNN6]
        models = 0
        ...
        predicti4 = models[3].predict(test)
        predicti5 = models[4].predict(test)
        predicti6 = models[5].predict(test)
        ...
        if modelss=="CNN" or modelss=="MCNN":
          ...
          if round(predicti4[0][0]) == 0:msg4 = 'No'
          if round(predicti4[0][0]) == 1:msg4 = 'Yes'
          ...
          if round(predicti4[0]) == 0:msg4 = 'No'
          if round(predicti4[0]) == 1:msg4 = 'Yes'
        ...
        output+='<tr><th>&nbsp;&nbsp;&nbsp;&nbsp;Asthma&nbsp;&nbsp;&nbsp;&nbsp;</th><th>&nbsp;&nbsp;&nbsp;&nbsp;KidneyDisease&nbsp;&nbsp;&nbsp;&nbsp;</th><th>&nbsp;&nbsp;&nbsp;&nbsp;Diabetes&nbsp;&nbsp;&nbsp;&nbsp;</th><th>&nbsp;&nbsp;&nbsp;&nbsp;Cancer&nbsp;&nbsp;&nbsp;&nbsp;</th><th>&nbsp;&nbsp;&nbsp;&nbsp;Stroke&nbsp;&nbsp;&nbsp;&nbsp;</th><th>&nbsp;&nbsp;&nbsp;&nbsp;HeartDisease&nbsp;&nbsp;&nbsp;&nbsp;</th></tr>'
        output+='<tr><td><center>'+color+str(msg1)+'</center></td><td><center>'+color+str(msg2)+'</center></td><td><center>'+color+str(msg3)+'</center></td><td><center>'+color+str(msg4)+'</center></td><td><center>'+color+str(msg5)+'</center></td><td><center>'+color+str(msg6)+'</center></td></tr></table><br><br><br></center>'
...
def AccuracyGraph():
    ...
    accmod = {"svm":svm_teacc,"mlp":mlp_teacc,"rf":rf_teacc,"KNN":knn_teacc,"GB":gb_teacc,"LGBM":lgbm_teacc,"ETC":etc_teacc,"CNN":cnn_teacc,"MCNN":mcnn_teacc}
    ...
    output= '<br><center>Best Model is : '+color+str(accmodel)+'  &  Accuracy is : '+color+str(accvalue)+'</center><br>'
    return render_template("ViewAccuracy.html",error=output)
