...
@app.route("/TrainSVM")
def TrainSVM():
    global classifier,accmod,svm_teacc,classifier1,classifier2,classifier3,classifier5,classifier6
...
@app.route("/TrainKNN")
def TrainKNN():
    global KNN,accmod,knn_teacc,KNN1,KNN2,KNN3,KNN5,KNN6
    global le1, le2, le3, le4, le5, le6, le7, le8, le9, le10, le11, le12, le13, le14, le15, le16, le17
...
@app.route("/TrainGB")
def TrainGB():
    global GBC,accmod,gb_teacc,GBC1,GBC2,GBC3,GBC5,GBC6
    global le1, le2, le3, le4, le5, le6, le7, le8, le9, le10, le11, le12, le13, le14, le15, le16, le17
...
@app.route("/TrainETC")
def TrainETC():
    global ETC,accmod,etc_teacc,ETC1,ETC2,ETC3,ETC5,ETC6
    global le1, le2, le3, le4, le5, le6, le7, le8, le9, le10, le11, le12, le13, le14, le15, le16, le17
...
@app.route("/TrainLGBM")
def TrainLGBM():
    global LGBM,accmod,lgbm_teacc,LGBM1,LGBM2,LGBM3,LGBM5,LGBM6
    global le1, le2, le3, le4, le5, le6, le7, le8, le9, le10, le11, le12, le13, le14, le15, le16, le17
...
@app.route("/TrainMLP")
def TrainMLP():
    global le1, le2, le3, le4, le5, le6, le7, le8, le9, le10, le11, le12, le13, le14, le15, le16, le17, MLP,accmod,mlp_teacc,MLP1,MLP2,MLP3,MLP5,MLP6
...
@app.route('/TrainRF')
def TrainRF():
    global le1, le2, le3, le4, le5, le6, le7, le8, le9, le10, le11, le12, le13, le14, le15, le16, le17,RF,accmod,rf_teacc,RF1,RF2,RF3,RF5,RF6
...
@app.route('/TrainCNN')
def TrainCNN():
    global le1, le2, le3, le4, le5, le6, le7, le8, le9, le10, le11, le12, le13, le14, le15, le16, le17,model,accmod,cnnaccuracy_vv,model1,model2,model3,model5,model6
    ...
    loss_v, cnnaccuracy_v = model.evaluate(X_test, Y_test, verbose=1)
    print("Validation: accuracy = %f  ;  loss_v = %f" % (accuracy, loss_v))
    print("Test: accuracy = %f  ;  loss = %f" % (cnnaccuracy_v*100, loss*100))
    accmod["CNN"] = cnnaccuracy_v*100
    
    
    cnnaccuracy_vv = cnnaccuracy_v*100
    
    output = cnnaccuracy_vv
    color = '<font size="" color="black">'
    ...
    output+='<tr><td>'+color+str(cnnaccuracy_vv)+'</td><td>'+color+str(cnnaccuracy_vv)+'</td><td>'+color+str(0)+'</td><td>'+color+str(0)+'</td><td>'+color+str(0)+'</td></tr>'
    output+='</table><br><a href="TrainModel">Back</a></center>'
...
def TrainMCNNN():
    global classifier,MLP,RF,LGBM,KNN,GBC,ETC
    global le1, le2, le3, le4, le5, le6, le7, le8, le9, le10, le11, le12, le13, le14, le15, le16, le17,mmodel,accmod,cnnaccuracy_v2v
